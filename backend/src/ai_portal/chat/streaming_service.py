"""Chat domain — streaming message layer.

Handles SSE streaming of LLM responses, history building, memory integration,
and tool orchestration within a streaming session.
"""
