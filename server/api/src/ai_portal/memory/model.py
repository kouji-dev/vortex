...
class MemoryEncryptionConfig(Base):
    """Per-org envelope-encryption config for memory.text (BYOK opt-in)."""

    __tablename__ = "memory_encryption_configs"
    ...
    kek_ref: Mapped[str] = mapped_column(String(128), nullable=False, default="env:MEMORY_KEK")
